...
class thirdSelectExerciseTypeScreenSubjectScreenII extends StatefulWidget {
  thirdSelectExerciseTypeScreenSubjectScreenII({super.key});

  @override
  State<thirdSelectExerciseTypeScreenSubjectScreenII> createState() =>
      _thirdSelectExerciseTypeScreenSubjectScreenIState();
}

class _thirdSelectExerciseTypeScreenSubjectScreenIState
    extends State<thirdSelectExerciseTypeScreenSubjectScreenII> {
  var materialsData = {
