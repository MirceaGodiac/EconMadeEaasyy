...
import 'package:econ_made_easy_files/Aplication_Screens/Exercitii%20Group/thirdSelectExerciseTypeScreenSubjectII.dart';
import 'package:flutter/material.dart';

class secondSelectExerciseTypeIIScreen extends StatefulWidget {
  const secondSelectExerciseTypeIIScreen({super.key});

  @override
  State<secondSelectExerciseTypeIIScreen> createState() =>
      _secondSelectExerciseTypeIIScreenState();
}

class _secondSelectExerciseTypeIIScreenState
    extends State<secondSelectExerciseTypeIIScreen> {
                  ...
                  child: InkWell(
                    onTap: () {
                      Navigator.pushReplacement(context, MaterialPageRoute(
                        builder: (context) {
                          return thirdSelectExerciseTypeScreenSubjectScreenII();
                        },
                      ));
                    },
                    child: Row(
