...
List quiz1 = [
  ...
  QuestionModel(
    "Au obiectele o valoare în bani?",
    {
      "Nu, se pot cumpăra și fără bani": false,
      "Da, și fericirea se poate cumpăra cu bani ": false,
      "Da, deoarece sunt vândute cu bani": true,
    },
  ),
  QuestionModel(
    "Putem obține obiecte alfel decât prin cumpărare?",
    {
      ...
      "Da, le putem face noi": true,
      "Nu, orice trebuie să fie cumpărat": false,
    },
  ),
  QuestionModel(
    "Este bine sau rău să ai bani?",
    {
      "Este rău, pentru că banii fac numai probleme": false,
      "Este bine pentru că voi putea să cumpăr lucruri necesare \nsau să-i ajut pe ceilalți":
          true,
      "Este rău pentru că trebuie să muncesc și nu-mi place": false,
    },
  ),
  QuestionModel(
    "Putem obține totul dacă avem bani?",
    {
      ...
      "Nu, prietenia, iubirea și fericirea nu se pot cumpăra": true,
      "Da, și e mereu la fel pentru toate": false,
    },
  ),
];
...
List quiz2 = [
  QuestionModel(
    "Sunt banii nelimitați?",
    {
      "Nu, aceștia vin și pleacă mereu": true,
      "Da, și putem cumpăra orice cu ei": false,
      "Da, aceștia cresc în copaci": false,
      "Nu, la un moment dat ei dispar": false,
    },
  ),
  QuestionModel("Prin economisire înțelegem că...", {
    "Trebuie să ne dăm toți banii noștri altcuiva": false,
    "Primim bani mulți de la cineva dintr-o dată": false,
  ...
  QuestionModel("Care sunt cele trei categorii în care împărțim banii?", {
    ...
    "Cumpărături, Muncă și Învățare": false,
  }),
  QuestionModel(
    "Ești la un magazin și trebuie să alegi ce să cumperi dintre o geacă frumoasă sau un medicament pentru bunicii tăi. Ce vei alege?",
    {
  ...
  QuestionModel(
    "Ce înseamnă să fii responsabil?",
    {
      ...
      "Să iei decizii bune, care te vor avantaja pe \nviitor în ciuda dorințelor tale din prezent":
          true,
      "Să ignori sfaturile celorlalți și să faci \nnumai cum crezi tu că e corect":
          false,
    },
  ),
  QuestionModel(
...
List quiz3 = [
  QuestionModel(
    "Ce înseamnă 'Buget'?",
    {
      ...
      "Bugetul înseamnă câți bani suntem dispuși să cheltuim": true,
    },
  ),
  QuestionModel(
  ...
  QuestionModel("Ce înseamnă 'termen lung'?", {
    "O perioadă mai mare de timp, din viitor": true,
    "O unitate de măsură": false,
  }),
  QuestionModel(
      "Când facem cumpărături, trebuie să ne gândim la efectul lor pe termen lung?",
      {
        "Fals": false,
        "Adevărat": true,
      }),
  ...
  QuestionModel(
      "Dacă un prieten spune că are nevoie de toți banii tăi, îi oferi ce cere?",
      {
        "Nu îi dau nimic, pentru că eu nu \nmă voi putea descurca fără ei":
            false,
        "Da, îi dau toți banii mei și găsesc \no cale să mă descurc": false,
        "Îi ofer o parte din banii mei pentru \ndaruri, și îi explic că nu pot da mai mult":
            true,
      }),
];
...
List quiz5 = [
  QuestionModel(
    "E ușor sau greu să muncești pentru bani?",
    {
      "Depinde de slujbă și dacă iți place \nce lucrezi, dar de obicei e greu":
          true,
      "Întotdeauna e greu": false,
      "Întotdeauna e ușor": false,
    },
  ),
...
List quiz7 = [
  ...
  QuestionModel("Ce înseamnă termenul 'troc'?", {
    "Un schimb de obiecte între oameni": true,
    "Înseamnă ceva petrecut în trecut": false,
...
List quiz8 = [
  QuestionModel(
    "Din ce este format un buget?",
    {
      "Din 3 secțiuni : Început, Mijloc și Final": false,
      "Din două coloane: Venituri și Cheltuieli": true,
      "Din 3 anotimpuri": false,
    },
  ),
  QuestionModel("Ce sunt cheltuielile?", {
    "Banii pe care i-am economisit de-a lungul anilor": false,
    "Atunci când avem prea mulți bani": false,
    "Suma de bani pe care dorim să o strângem prin economii": false,
    "Totalitatea banilor dați la schimb pentru lucruri \nnecesare sau servicii necesare":
        true,
  }),
...
List quiz9 = [
  ...
  QuestionModel("În videoclip, de ce măresc vânzătorii prețurile?", {
    "Banca Națională nu e conștientă de schimbările prețurilor": false,
    "Când cererea e mare, vânzătorii cresc prețurile": true,
  ...
  QuestionModel(
      ...
      {
        "Prețurile sunt mărite din cauza lipsei de marfă": false,
        "Stocul a scăzut, rămânând doar marfa nedorită": true,
        "Cei 3 nu au avut destui bani pentru peștele dorit": false,
        "Aceștia nu s-au putut decide": false,
      }),
  QuestionModel("De ce au mers cei trei la piață așa de devreme?", {
    "Singurul autobus care i-ar fi putut transporta la piață pleca devreme":
        false,
    "S-au trezit devreme așa că au decis să meargă la piață": false,
    "Era sezon, ceea ce înseamnă că prețurile erau mai mici": true,
    "Ana a venit cu ideea de a cumpăra păstrăv": false,
  }),
...
List quiz10 = [
  QuestionModel(
    "De ce nu cumpără copiii jocul abia apărut pe piață?",
    {
      "Bunicul lor nu le dă voie": false,
      "Pentru că nu au destui bani": false,
      "Pentru că mai au jocuri neterminate de jucat": true,
      "Au ajuns prea târziu la magazin ": false,
    },
  ),
...
List quiz11 = [
  QuestionModel(
    "De ce nu are voie Radu să-și scrie codul PIN pe card?",
    {
      "Bunica nu l-a lăsat": false,
      "PIN-ul trebuie să îl știe numai el": true,
      "Ana i-a interzis": false,
    },
  ),
  QuestionModel("Cum trebuie făcute cumpărăturile online?", {
    "Numai noaptea": false,
    "Întotdeauna după școală": false,
    "În timpul zilei": false,
    "În prezența bunicilor sau a părinților": true,
  }),
  QuestionModel("Cum putem ști constant câți bani avem pe card?", {
    "Doar dacă mergem la bancă": false,
    "Aplicația de pe telefon afișează câți bani rămân\nîn urma cheltuielilor":
        true,
  ...
  QuestionModel("Care sunt elementele de siguranță ale unui card?", {
    ...
    "Numărul cardului, Numele, Data la care expiră, \ncodul de securitate de pe spate (CVC)":
        true,
    "Conținutul, formularea, lizibilitatea": false,
  }),
  QuestionModel("PIN-ul și codul CVC sunt același lucru?", {
    "Da": false,
    "Nu": true,
  }),
  QuestionModel("Ce trebuie să facem în caz că ni se fură cardul?", {
    "Sunăm la 112": false,
    "Sunăm la bancă sau întrăm în aplicație că să-l blocăm": true,
    "Spunem unui coleg": false,
    "Nimic": false,
  }),
  QuestionModel("Unde putem păstra codul PIN?", {
    "Pe o hârtie separată de card sau în telefon ascunsă\nprintr-un nume inventat":
        true,
    "Îl scriem pe card": false,
    "Îl spunem unei persoane de încredere": false,
  }),
];
